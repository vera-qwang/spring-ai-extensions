...
/**
 * Test cases for DashScopeStoreOptions. Tests cover constructor, getters/setters, and option
 * configurations.
 *
 * @author yuluo
...
class DashScopeStoreOptionsTests {
  ...
  /**
   * Test constructor with index name. Verifies that the index name is correctly set in the
   * constructor.
   */
  @Test
  ...
  /**
   * Test setters and getters for all options. Verifies that all options can be set and retrieved
   * correctly.
   */
  @Test
  void testSettersAndGetters() {
    ...
    DashScopeDocumentTransformerOptions transformerOptions =
        new DashScopeDocumentTransformerOptions();
    ...
    DashScopeEmbeddingOptions embeddingOptions =
        DashScopeEmbeddingOptions.builder().model(TEST_EMBEDDING_MODEL).build();
    ...
    DashScopeDocumentRetrieverOptions retrieverOptions =
        DashScopeDocumentRetrieverOptions.builder().rerankModelName(TEST_RERANK_MODEL).build();
  ...
  /**
   * Test setting index name after construction. Verifies that the index name can be modified after
   * object creation.
   */
  @Test
  ...
  /**
   * Test setting transformer options with default values. Verifies that transformer options with
  ...
  /**
   * Test setting embedding options with custom configuration. Verifies that embedding options can
   * be customized and retrieved correctly.
   */
  @Test
  ...
  /**
   * Test setting retriever options with custom configuration. Verifies that retriever options can
   * be customized and retrieved correctly.
   */
  @Test
