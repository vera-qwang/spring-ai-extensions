 ...
 */
package com.alibaba.cloud.ai.vectorstore.analyticdb.autoconfigure;
...
@ConditionalOnProperty(prefix = "spring.ai.vectorstore.analyticdb", name = "enabled", havingValue = "true",
		matchIfMissing = true)
